...
$query = "INSERT INTO dblockdata (enroll,name,faculty,branch,room) VALUES('$enroll','$name','$faculty','$branch','$room')";
$query_run = mysqli_query($connection, $query);
         ...
         header('Location: dblockdata.php');   
...
if(isset($_POST['updatebtn']))
{
    ...
    $query = "UPDATE dblockdata SET enroll='$enroll',name ='$name',faculty='$faculty', branch='$branch',room='$room', WHERE ID= '$ID'";
    $query_run = mysqli_query($connection, $query);
